...
<div data-enabled="<?php echo hillstar_footer_parallax_is_enabled();?>" data-colibri-component="footer-parallax" data-colibri-id="13-f1" class="page-footer style-62 style-local-13-f1 position-relative">
